  ...
  return (
    ...
    >
      ...
      <div className="md:hidden print:hidden relative">
        ...
        <div className={cn(
          "absolute top-0 right-0 z-10 transition-all duration-300 print:hidden",
      ...
      <div className="hidden md:grid print:!grid grid-cols-[264px_1fr_auto] print:!grid-cols-[220px_1fr_auto] gap-20 items-center">
