    ...
    <article className="w-full flex flex-col items-center">
      ...
      <figure className="inline-flex flex-col items-start max-w-[90vw] md:max-w-[70vw] lg:max-w-[60vw] mx-auto">
        ...
        >
          ...
          {currentImage && (
            <ProgressiveImage
              ...
              className="relative z-10 w-full [&_img]:max-h-[55vh] [&_img]:md:max-h-[60vh] [&_img]:lg:max-h-[65vh]"
              objectFit="contain"
              eager={false}
              blurUp
              modernFormats
        ...
        <figcaption className="mt-6 md:mt-8 space-y-0 text-left leading-snug">
          <p className="font-baskerville text-stone-900 text-sm md:text-base font-medium">
            {artwork.title}
