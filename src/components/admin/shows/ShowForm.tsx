...
import { useCreateShow, useUpdateShow, useUploadShowImage, useAddShowImage, useDeleteShowImage } from "@/hooks/useShowMutations";
...
const ShowForm = ({ show, onBack }: ShowFormProps) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-xl font-semibold">{show ? "Edit Show" : "New Show"}</h2>
      </div>
